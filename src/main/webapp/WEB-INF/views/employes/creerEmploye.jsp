		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="<c:url value="lister" />">Bulletins</a>
					</li>
				</ul>
			</div>
		</nav>
				...
				<form:form method="POST" modelAttribute="remunerationEmploye" accept-charset="UTF-8">
					...
					<div class="form-group row p-3 pl-5">
						<label for="selectGrade" class="col-sm-2 col-form-label">Grade
							: </label>
						<div class="col-sm-8">
							<form:select path="grade.id" items="${grades}" itemValue="id" itemLabel="code"  class="form-control" id="selectGrade" name="grade">
							</form:select>
						</div>
					</div>
