...
public class PaieUtilsTest {
	...
	@Test
	public void test_formaterBigDecimal_six_chiffres_apres_la_virgule() {
		String resultat = paieUtils.formaterBigDecimal(new BigDecimal("6.148946"));
		assertThat(resultat, equalTo("6.15"));
	}
